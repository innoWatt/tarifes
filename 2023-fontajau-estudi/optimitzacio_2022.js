...
/*FUNCIONS HELPER*/
  function tarifa6(input){
    ...
    */
    ...
    console.log(" Terme Penalitzacions [€]: "+excessos[fi].toFixed(2));
...
/*VARIABLES GLOBALS*/
  ...
  let potConP1 = 150; //kW contractats
  let potConP2 = 150; //kW contractats
  let potConP3 = 150; //kW contractats
  let potConP4 = 150; //kW contractats
  let potConP5 = 150; //kW contractats
  let potConP6 = 150; //kW contractats
  ...
  let festius=[
    ...
    new DiaFestiu(new Date(Date.UTC(2022,des,26)),"Lunes siguiente a Navidad"  ),//2022
...
let pot_ini = 210;//inicial
let pot_fin = 270;//final
let pot_stp =  20;//step
        ...
        for(  let p5=pot_ini; p5<=pot_fin; p5+=pot_stp){
          for(let p6=pot_ini; p6<=pot_fin; p6+=pot_stp){
            if(p1<=p2 && p2<=p3 && p3<=p4 && p4<=p5 && p5<=p6){
              ...
              let cost = tots_els_mesos();
              console.log(`combinació actual: ${p1} ${p2} ${p3} ${p4} ${p5} ${p6}: ${cost}€`);
